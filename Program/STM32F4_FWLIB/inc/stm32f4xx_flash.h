...
/** @defgroup FLASH_Option_Bytes_Read_Protection 读保护等级
  * @{
  */
...
/** @defgroup FLASH_Option_Bytes_IWatchdog 选项字节功能配置为看门狗事件
  * @{
  */ 
...
/** @defgroup FLASH_Option_Bytes_nRST_STOP 进入停止模式产生复位事件
  * @{
  */ 
...
/** @defgroup FLASH_Option_Bytes_nRST_STDBY 进入待机模式时产生复位事件
  * @{
  */ 
...
/** @defgroup FLASH_BOR_Reset_Level 电压范围
  * @{
  */  
