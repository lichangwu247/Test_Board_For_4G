...
void LCD_Clear_Area(u16 sx,u16 sy,u16 ex,u16 ey,u16 color); //清除屏幕一个区域函数
...
void LCD_Draw_Straight_Line(u16 sx,u16 sy,u16 ex,u16 ey,u16 color);//画一条直线	  	   																			 
void LCD_Draw_Vertical_Line(u16 sx,u16 sy,u16 ex,u16 ey,u16 color);//画一条竖线		
void LCD_Draw_Rectangle(u16 sx,u16 sy,u16 ex,u16 ey,u16 color);//画一个矩形
#endif  
