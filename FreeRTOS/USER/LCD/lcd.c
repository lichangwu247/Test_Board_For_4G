  ...
  u16 Location_y=sy;
	...
	for(i=0;i<pointnum;i++)
	{
		...
		{ 
			...
			LCD_SetCursor(sx,Location_y);	       //设置光标位置 
			LCD_WriteRAM_Prepare();     		 //开始写入GRAM	 	  
		}	
		LCD_DATA=color;	   
	}
...
/****************************************************************************
* 名    称: void LCD_Draw_Line(u16 sx,u16 sy,u16 color)
* 功    能：线一条直线
* 入口参数：(sx,sy):起点
*						(ex,ey):终点
            color:  画笔颜色
...
/****************************************************************************
* 名    称: void LCD_Draw_Vertical_Line(u16 sx,u16 sy,u16 color)
* 功    能：线一条竖线
* 入口参数：(sx,sy):起点
*						(ex,ey):终点
            color:  画笔颜色
...
/****************************************************************************
* 名    称: void LCD_Draw_Rectangle(u16 sx,u16 sy,u16 color)
* 功    能：画一个矩形
* 入口参数：(sx,sy):第一个顶点坐标
*						(ex,ey):第二个顶点坐标
            color:  画笔颜色
...
{
	LCD_Draw_Straight_Line(sx,sy,ex,ey,color);//画第一条直线
	LCD_Draw_Straight_Line(sx,ey,ex,ey,color);//画第二条直线
	LCD_Draw_Vertical_Line(sx,sy,sx,ey,color);//画第一条竖线
	LCD_Draw_Vertical_Line(ex,sy,ex,ey,color);//画第二条竖线
}
/****************************************************************************
